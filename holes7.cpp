...
},
{
	.testid=5,
	.input_rectangles = {
		{.m_left=128-RECT_BORDER,.m_right=234+RECT_BORDER,.m_bottom=210+RECT_BORDER,.m_top=138-RECT_BORDER},
		{.m_left=190-RECT_BORDER,.m_right=316+RECT_BORDER,.m_bottom=338+RECT_BORDER,.m_top=250-RECT_BORDER},
		{.m_left=760-RECT_BORDER,.m_right=900+RECT_BORDER,.m_bottom=289+RECT_BORDER,.m_top=217-RECT_BORDER},
		{.m_left=16-RECT_BORDER,.m_right=150+RECT_BORDER,.m_bottom=498+RECT_BORDER,.m_top=330-RECT_BORDER},
		{.m_left=357-RECT_BORDER,.m_right=448+RECT_BORDER,.m_bottom=481+RECT_BORDER,.m_top=329-RECT_BORDER},
		{.m_left=190-RECT_BORDER,.m_right=317+RECT_BORDER,.m_bottom=482+RECT_BORDER,.m_top=378-RECT_BORDER},
		{.m_left=274-RECT_BORDER,.m_right=366+RECT_BORDER,.m_bottom=210+RECT_BORDER,.m_top=138-RECT_BORDER},
		{.m_left=940-RECT_BORDER,.m_right=1052+RECT_BORDER,.m_bottom=273+RECT_BORDER,.m_top=217-RECT_BORDER},
		{.m_left=614-RECT_BORDER,.m_right=720+RECT_BORDER,.m_bottom=273+RECT_BORDER,.m_top=217-RECT_BORDER},
		{.m_left=488-RECT_BORDER,.m_right=642+RECT_BORDER,.m_bottom=401+RECT_BORDER,.m_top=313-RECT_BORDER},
		{.m_left=490-RECT_BORDER,.m_right=574+RECT_BORDER,.m_bottom=273+RECT_BORDER,.m_top=185-RECT_BORDER},
		{.m_left=710-RECT_BORDER,.m_right=858+RECT_BORDER,.m_bottom=385+RECT_BORDER,.m_top=329-RECT_BORDER},
		{.m_left=898-RECT_BORDER,.m_right=1192+RECT_BORDER,.m_bottom=497+RECT_BORDER,.m_top=393-RECT_BORDER},
		{.m_left=718-RECT_BORDER,.m_right=858+RECT_BORDER,.m_bottom=497+RECT_BORDER,.m_top=425-RECT_BORDER},
		{.m_left=614-RECT_BORDER,.m_right=971+RECT_BORDER,.m_bottom=177+RECT_BORDER,.m_top=41-RECT_BORDER},
		{.m_left=1011-RECT_BORDER,.m_right=1193+RECT_BORDER,.m_bottom=177+RECT_BORDER,.m_top=57-RECT_BORDER},
		{.m_left=128-RECT_BORDER,.m_right=352+RECT_BORDER,.m_bottom=98+RECT_BORDER,.m_top=26-RECT_BORDER},
		{.m_left=10-RECT_BORDER,.m_right=150+RECT_BORDER,.m_bottom=290+RECT_BORDER,.m_top=250-RECT_BORDER},
		{.m_left=17-RECT_BORDER,.m_right=88+RECT_BORDER,.m_bottom=98+RECT_BORDER,.m_top=10-RECT_BORDER},
		{.m_left=10-RECT_BORDER,.m_right=88+RECT_BORDER,.m_bottom=210+RECT_BORDER,.m_top=138-RECT_BORDER}
	},		
	.logical_edges = {
		{.from=0,.to=1},
		{.from=0,.to=2},
