...
void test_compact_frame()
{
	...
	},
	{
		.testid=3,
		.input_rectangles = {
			{.m_left=396-RECT_BORDER+2*FRAME_BORDER, .m_right=396+162+RECT_BORDER+2*FRAME_BORDER, .m_top=10-RECT_BORDER+2*FRAME_BORDER, .m_bottom=10+104+RECT_BORDER+2*FRAME_BORDER},//8
			{.m_left=320-RECT_BORDER+2*FRAME_BORDER, .m_right=320+182+RECT_BORDER+2*FRAME_BORDER, .m_top=330-RECT_BORDER+2*FRAME_BORDER, .m_bottom=330+72+RECT_BORDER+2*FRAME_BORDER},//9
			{.m_left=453-RECT_BORDER+2*FRAME_BORDER, .m_right=453+105+RECT_BORDER+2*FRAME_BORDER, .m_top=218-RECT_BORDER+2*FRAME_BORDER, .m_bottom=218+72+RECT_BORDER+2*FRAME_BORDER},//10
			{.m_left=598-RECT_BORDER+2*FRAME_BORDER, .m_right=598+126+RECT_BORDER+2*FRAME_BORDER, .m_top=10-RECT_BORDER+2*FRAME_BORDER, .m_bottom=10+152+RECT_BORDER+2*FRAME_BORDER},//21
			{.m_left=598-RECT_BORDER+2*FRAME_BORDER, .m_right=598+126+RECT_BORDER+2*FRAME_BORDER, .m_top=202-RECT_BORDER+2*FRAME_BORDER, .m_bottom=202+88+RECT_BORDER+2*FRAME_BORDER},//24
			{.m_left=750-RECT_BORDER+2*FRAME_BORDER, .m_right=750+147+RECT_BORDER+2*FRAME_BORDER, .m_top=346-RECT_BORDER+2*FRAME_BORDER, .m_bottom=346+120+RECT_BORDER+2*FRAME_BORDER},//25
			{.m_left=273-RECT_BORDER+2*FRAME_BORDER, .m_right=273+140+RECT_BORDER+2*FRAME_BORDER, .m_top=154-RECT_BORDER+2*FRAME_BORDER, .m_bottom=154+120+RECT_BORDER+2*FRAME_BORDER},//26
			{.m_left=542-RECT_BORDER+2*FRAME_BORDER, .m_right=542+168+RECT_BORDER+2*FRAME_BORDER, .m_top=330-RECT_BORDER+2*FRAME_BORDER, .m_bottom=330+136+RECT_BORDER+2*FRAME_BORDER},//27
			{.m_left=335-RECT_BORDER+2*FRAME_BORDER, .m_right=335+168+RECT_BORDER+2*FRAME_BORDER, .m_top=506-RECT_BORDER+2*FRAME_BORDER, .m_bottom=506+120+RECT_BORDER+2*FRAME_BORDER},//28
			{.m_left=556-RECT_BORDER+2*FRAME_BORDER, .m_right=556+147+RECT_BORDER+2*FRAME_BORDER, .m_top=506-RECT_BORDER+2*FRAME_BORDER, .m_bottom=506+104+RECT_BORDER+2*FRAME_BORDER},//30
			{.m_left=764-RECT_BORDER+2*FRAME_BORDER, .m_right=764+133+RECT_BORDER+2*FRAME_BORDER, .m_top=186-RECT_BORDER+2*FRAME_BORDER, .m_bottom=186+120+RECT_BORDER+2*FRAME_BORDER},//32
			{.m_left=743-RECT_BORDER+2*FRAME_BORDER, .m_right=743+147+RECT_BORDER+2*FRAME_BORDER, .m_top=506-RECT_BORDER+2*FRAME_BORDER, .m_bottom=506+168+RECT_BORDER+2*FRAME_BORDER},//44
			{.m_left=93-RECT_BORDER+2*FRAME_BORDER, .m_right=93+140+RECT_BORDER+2*FRAME_BORDER, .m_top=153-RECT_BORDER+2*FRAME_BORDER, .m_bottom=153+88+RECT_BORDER+2*FRAME_BORDER},//48
			{.m_left=10-RECT_BORDER+2*FRAME_BORDER, .m_right=10+155+RECT_BORDER+2*FRAME_BORDER, .m_top=281-RECT_BORDER+2*FRAME_BORDER, .m_bottom=281+120+RECT_BORDER+2*FRAME_BORDER},//52
			{.m_left=11-RECT_BORDER+2*FRAME_BORDER, .m_right=11+175+RECT_BORDER+2*FRAME_BORDER, .m_top=441-RECT_BORDER+2*FRAME_BORDER, .m_bottom=441+136+RECT_BORDER+2*FRAME_BORDER}//53
		},
